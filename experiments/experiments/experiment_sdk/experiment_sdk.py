...
class ExperimentSDK:
    ...
    def frames_almost_equal(self, df1: pd.DataFrame, df2: pd.DataFrame, tol=1e-6) -> bool:
        """
    ...
    def run_grouped_simulation(self, visualize=False):
        ...
        if visualize:
            corrected_forcasted_values = self.data_transformation.undo_transformation_for_forcast(performance['forecast'], selected_columns, normalized_dataset_reserve.columns)
            self.visualizer.plot_true_and_predictions(dataset, corrected_forcasted_values)
