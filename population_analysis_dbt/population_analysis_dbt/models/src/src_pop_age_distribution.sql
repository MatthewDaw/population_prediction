...
early_years_renamed AS (
    SELECT
        ...
        year,
        CAST(alabamatotalestimate AS NUMERIC) / 100.0 AS alabama,
        CAST(alaskatotalestimate AS NUMERIC) / 100.0 AS alaska,
        CAST(arizonatotalestimate AS NUMERIC) / 100.0 AS arizona,
        CAST(arkansastotalestimate AS NUMERIC) / 100.0 AS arkansas,
        CAST(californiatotalestimate AS NUMERIC) / 100.0 AS california,
        CAST(coloradototalestimate AS NUMERIC) / 100.0 AS colorado,
        CAST(connecticuttotalestimate AS NUMERIC) / 100.0 AS connecticut,
        CAST(delawaretotalestimate AS NUMERIC) / 100.0 AS delaware,
        CAST(district_of_columbiatotalestimate AS NUMERIC) / 100.0 AS district_of_columbia,
        CAST(floridatotalestimate AS NUMERIC) / 100.0 AS florida,
        CAST(georgiatotalestimate AS NUMERIC) / 100.0 AS georgia,
        CAST(hawaiitotalestimate AS NUMERIC) / 100.0 AS hawaii,
        CAST(idahototalestimate AS NUMERIC) / 100.0 AS idaho,
        CAST(illinoistotalestimate AS NUMERIC) / 100.0 AS illinois,
        CAST(indianatotalestimate AS NUMERIC) / 100.0 AS indiana,
        CAST(iowatotalestimate AS NUMERIC) / 100.0 AS iowa,
        CAST(kansastotalestimate AS NUMERIC) / 100 AS kansas,
        CAST(kentuckytotalestimate AS NUMERIC) / 100.0 AS kentucky,
        CAST(louisianatotalestimate AS NUMERIC) / 100.0 AS louisiana,
        CAST(mainetotalestimate AS NUMERIC) / 100.0 AS maine,
        CAST(marylandtotalestimate AS NUMERIC) / 100.0 AS maryland,
        CAST(massachusettstotalestimate AS NUMERIC) / 100.0 AS massachusetts,
        CAST(michigantotalestimate AS NUMERIC) / 100.0 AS michigan,
        CAST(minnesotatotalestimate AS NUMERIC) / 100.0 AS minnesota,
        CAST(mississippitotalestimate AS NUMERIC) / 100.0 AS mississippi,
        CAST(missouritotalestimate AS NUMERIC) / 100.0 AS missouri,
        CAST(montanatotalestimate AS NUMERIC) / 100.0 AS montana,
        CAST(nebraskatotalestimate AS NUMERIC) / 100.0 AS nebraska, 
        CAST(nevadatotalestimate AS NUMERIC) / 100.0 AS nevada,
        CAST(new_hampshiretotalestimate AS NUMERIC) / 100.0 AS new_hampshire,
        CAST(new_jerseytotalestimate AS NUMERIC) / 100.0 AS new_jersey,
        CAST(new_mexicototalestimate AS NUMERIC) / 100.0 AS new_mexico,
        CAST(new_yorktotalestimate AS NUMERIC) / 100.0 AS new_york,
        CAST(north_carolinatotalestimate AS NUMERIC) / 100.0 AS north_carolina,
        CAST(north_dakotatotalestimate AS NUMERIC) / 100.0 AS north_dakota,
        CAST(ohiototalestimate AS NUMERIC) / 100.0 AS ohio,
        CAST(oklahomatotalestimate AS NUMERIC) / 100.0 AS oklahoma,
        CAST(oregontotalestimate AS NUMERIC) / 100.0 AS oregon,
        CAST(pennsylvaniatotalestimate AS NUMERIC) / 100.0 AS pennsylvania,
        CAST(rhode_islandtotalestimate AS NUMERIC) / 100.0 AS rhode_island,
        CAST(south_carolinatotalestimate AS NUMERIC) / 100.0 AS south_carolina,
        CAST(south_dakotatotalestimate AS NUMERIC) / 100.0 AS south_dakota,
        CAST(tennesseetotalestimate AS NUMERIC) / 100.0 AS tennessee,
        CAST(texastotalestimate AS NUMERIC) / 100.0 AS texas,
        CAST(utahtotalestimate AS NUMERIC) / 100.0 AS utah,
        CAST(vermonttotalestimate AS NUMERIC) / 100.0 AS vermont,
        CAST(virginiatotalestimate AS NUMERIC) / 100.0 AS virginia,
        CAST(washingtontotalestimate AS NUMERIC) / 100.0 AS washington,
        CAST(west_virginiatotalestimate AS NUMERIC) / 100.0 AS west_virginia,
        CAST(wisconsintotalestimate AS NUMERIC) / 100.0 AS wisconsin,
        CAST(wyomingtotalestimate AS NUMERIC) / 100.0 AS wyoming,
        CAST(puerto_ricototalestimate AS NUMERIC) / 100.0 AS puerto_rico
