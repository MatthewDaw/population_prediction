WITH grouped_housing_price_index as (
    select state_id, year, avg(house_price_index) as house_price_index FROM {{ ref('fct_housing_price_index') }} group by state_id, year
)
...
select
    ...
    grouped_housing_price_index.house_price_index,
...
JOIN
grouped_housing_price_index
ON grouped_housing_price_index.state_id = births.state_id and grouped_housing_price_index.year = births.year
JOIN
